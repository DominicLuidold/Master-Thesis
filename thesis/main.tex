...
Im nächsten Schritt erfolgt eine detaillierte Analyse des Aufgabenbereichs und der Arbeitsweise der \acl{fek}. Dabei wird der aktuelle Prozess rund um das Erstellen und Einreichen von Ethikanträgen ausführlich beleuchtet. Durch gezielte Interviews mit Mitgliedern der \ac{fek} sowie ehemaligen Antragsteller:innen werden mögliche Stärken und Schwachstellen identifiziert und etwaige Wünsche für ein neues System erörtert.
...
\vspace{5cm}
\noindent
Dornbirn, am \colorbox{yellow}{[Tag. Monat Jahr anführen]}\hfill Dominic Luidold, BSc
