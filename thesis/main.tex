...
Wie in Kapitel \ref{chap:einleitung} ab Seite \pageref{chap:einleitung} bereits initial angesprochen wurde, stößt die aktuell eingesetzte Word"=Antragsvorlage sowohl auf technische als auch auf inhaltliche Limitierungen. Diese kommen nicht nur während des Erstellens und Ausfüllens des Ethikantrages auf, sondern sind auch im Vorfeld zur Entscheidung für einen Ethikantrag und im weiteren Verlauf des Prozesses bemerkbar.

Der nachfolgende Abschnitt beschäftigt sich daher mit den Schwächen \& Problemen des aktuellen Systems, sowohl aus sicht der \ac{fek} als auch aus Sicht von Antragsstellenden. Etwaige Stärken, die das aktuelle System vorweist, werden dabei nicht außer Acht gelassen und ebenso genauer betrachtet und hervorgehoben.
...
\subsubsection*{Umstrukturierungy des Prozesses}
...
Alle zu befüllenden Felder sind mit einer eindeutigen Nummer gekennzeichnet und umfassen vom Projekttitel über detaillierte Angabe von geplanten Therapie- und Diagnostikverfahren bis hin zu Angaben zu Biometrie und Datenschutz und sind dabei auf insgesamt 14 Themenblöcke aufgeteilt.
