\documentclass[a4paper,12pt,twoside,numbers=noendperiod]{scrreprt}
...
\usepackage[
    pdfauthor={Dominic Luidold, BSc},
    pdftitle={Praxisnahe Anwendung der User-Centered Design Prinzipien: Neuentwicklung des Ethikantrag-Tools der Forschungsethik-Kommission der Fachhochschule Vorarlberg}
]{hyperref}                         % Links
\usepackage[
    style=ieee,
    citestyle=ieee,
...
\usepackage[titletoc]{appendix}     % Anhang
...
\section{Erläuterung des Konzepts}
